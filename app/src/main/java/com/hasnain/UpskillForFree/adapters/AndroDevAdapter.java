...
public class AndroDevAdapter extends FirebaseRecyclerAdapter<AndroidDevResponse,AndroDevAdapter.myViewHolder> {
    /**
    ...
    public AndroDevAdapter(@NonNull FirebaseRecyclerOptions<AndroidDevResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull AndroDevAdapter.myViewHolder holder, int position, @NonNull AndroidDevResponse model) {
    ...
    @NonNull
    @Override
    public AndroDevAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new AndroDevAdapter.myViewHolder(view);
    }
