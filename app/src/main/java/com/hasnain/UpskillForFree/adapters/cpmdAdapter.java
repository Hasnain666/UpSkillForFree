...
public class cpmdAdapter extends FirebaseRecyclerAdapter<CpmdResponse,cpmdAdapter.myViewHolder> {
    /**
    ...
    public cpmdAdapter(@NonNull FirebaseRecyclerOptions<CpmdResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull cpmdAdapter.myViewHolder holder, int position, @NonNull CpmdResponse model) {
    ...
    @NonNull
    @Override
    public cpmdAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new cpmdAdapter.myViewHolder(view);
    }
