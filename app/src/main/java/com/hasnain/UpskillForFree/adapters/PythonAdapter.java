...
public class PythonAdapter extends FirebaseRecyclerAdapter<PythonResponse,PythonAdapter.myViewHolder> {
    /**
    ...
    public PythonAdapter(@NonNull FirebaseRecyclerOptions<PythonResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull PythonAdapter.myViewHolder holder, int position, @NonNull PythonResponse model) {
    ...
    @NonNull
    @Override
    public PythonAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new PythonAdapter.myViewHolder(view);
    }
