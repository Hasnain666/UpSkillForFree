...
public class GoLangAdapter extends FirebaseRecyclerAdapter<GoLangResponse,GoLangAdapter.myViewHolder> {
    /**
    ...
    public GoLangAdapter(@NonNull FirebaseRecyclerOptions<GoLangResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull GoLangAdapter.myViewHolder holder, int position, @NonNull GoLangResponse model) {
    ...
    @NonNull
    @Override
    public GoLangAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new GoLangAdapter.myViewHolder(view);
    }
