...
public class DataScienceAdapter extends FirebaseRecyclerAdapter<DataScienceResponse,DataScienceAdapter.myViewHolder> {
    /**
    ...
    public DataScienceAdapter(@NonNull FirebaseRecyclerOptions<DataScienceResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull DataScienceAdapter.myViewHolder holder, int position, @NonNull DataScienceResponse model) {
    ...
    @NonNull
    @Override
    public DataScienceAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new DataScienceAdapter.myViewHolder(view);
    }
