...
public class JavaAdapter extends FirebaseRecyclerAdapter<JavaResponse,JavaAdapter.myViewHolder> {
    /**
    ...
    public JavaAdapter(@NonNull FirebaseRecyclerOptions<JavaResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull JavaAdapter.myViewHolder holder, int position, @NonNull JavaResponse model) {
    ...
    @NonNull
    @Override
    public JavaAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
