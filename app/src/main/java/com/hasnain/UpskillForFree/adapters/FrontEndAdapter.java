...
public class FrontEndAdapter extends FirebaseRecyclerAdapter<FrontEndResponse,FrontEndAdapter.myViewHolder> {
    /**
    ...
    public FrontEndAdapter(@NonNull FirebaseRecyclerOptions<FrontEndResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull FrontEndAdapter.myViewHolder holder, int position, @NonNull FrontEndResponse model) {
    ...
    @NonNull
    @Override
    public FrontEndAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
