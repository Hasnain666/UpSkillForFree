...
public class JavaScriptAdapter extends FirebaseRecyclerAdapter<JavaScriptResponse,JavaScriptAdapter.myViewHolder> {
    /**
    ...
    public JavaScriptAdapter(@NonNull FirebaseRecyclerOptions<JavaScriptResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull JavaScriptAdapter.myViewHolder holder, int position, @NonNull JavaScriptResponse model) {
    ...
    @NonNull
    @Override
    public JavaScriptAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new JavaScriptAdapter.myViewHolder(view);
    }
