...
public class IosDevAdapter extends FirebaseRecyclerAdapter<IosDevResponse,IosDevAdapter.myViewHolder> {
    /**
    ...
    public IosDevAdapter(@NonNull FirebaseRecyclerOptions<IosDevResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull IosDevAdapter.myViewHolder holder, int position, @NonNull IosDevResponse model) {
    ...
    @NonNull
    @Override
    public IosDevAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new IosDevAdapter.myViewHolder(view);
    }
