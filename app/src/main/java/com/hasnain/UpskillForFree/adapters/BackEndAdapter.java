...
public class BackEndAdapter extends FirebaseRecyclerAdapter<BackEndResponse,BackEndAdapter.myViewHolder> {
    /**
    ...
    public BackEndAdapter(@NonNull FirebaseRecyclerOptions<BackEndResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull BackEndAdapter.myViewHolder holder, int position, @NonNull BackEndResponse model) {
    ...
    @NonNull
    @Override
    public BackEndAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view
                = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.courses_links, parent, false);
        return new BackEndAdapter.myViewHolder(view);
    }
