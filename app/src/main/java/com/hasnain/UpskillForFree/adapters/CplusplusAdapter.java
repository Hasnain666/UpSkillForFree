...
public class CplusplusAdapter extends FirebaseRecyclerAdapter<CplusplusResponse, CplusplusAdapter.myViewHolder> {
    /**
    ...
    public CplusplusAdapter(@NonNull FirebaseRecyclerOptions<CplusplusResponse> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull CplusplusResponse model) {
